  ...
  const projects = [
    {
      ...
      desc: 'Facial recognition attendance system with role-based dashboards (admin/teacher) and offline kiosk mode. Achieved 96% accuracy and reduced manual effort by 80%.',
    ...
    },
    {
      ...
      desc: 'Production system for meal balance tracking, real-time deduction and reporting. Served 500+ employees daily and integrated with existing HR systems.',
    ...
    },
    {
      ...
      desc: 'Housing price prediction model with 88% R², deployed as a lightweight API for demo. Used feature engineering and hyperparameter tuning.',
