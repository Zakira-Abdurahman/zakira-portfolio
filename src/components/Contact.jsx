      ...
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <div className="bg-linear-to-br from-indigo-950/30 to-purple-950/30 rounded-2xl p-8 border border-purple-500/20 backdrop-blur-sm">
          <p className="text-gray-200 text-lg mb-8">
            Open to software engineering roles, collaborations, or just a tech chat — feel free to reach out!
          </p>
          <div className="flex justify-center gap-8 mb-8 text-3xl">
            <a
              href="https://github.com/zakiraabdurahman"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/zakiraabdurahman/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-white transition-transform hover:scale-110"
            >
            ...
            <a
              href="mailto:zakira.abdurahman@example.com"
              className="text-gray-300 hover:text-white transition-transform hover:scale-110"
            >
              <i className="fas fa-envelope"></i>
            </a>
            <a href="#" className="text-gray-300 hover:text-white transition-transform hover:scale-110">
          ...
          <p className="mt-8 text-sm text-gray-400">
            📍 Addis Ababa, Ethiopia | ✉️ zakira.abdurahman@example.com
          </p>
        </div>
      </div>
    </section>
